                    ...
                    for($h=0;$h<count($half_word_var);$h++)
                    {
                        ...
                        // echo $half_word_var[$h];
                            ...
                            )
                            {
                                ...
                                $suffix_can[$k]=$lemmas[$j]."<u>похоже</u>";
                                ...
                                if($lemmas[$j]=="Pr"||$lemmas[$j]=="O"||$lemmas[$j]=="Im"||$lemmas[$j]=="Ip"||$lemmas[$j]=="PrSb")
                                {
                                    ...
                                    //case "Pr":
                                        if($suffix_var[$s]=="a")
                                        {
                                            $last_letter_ps=mb_substr($half_word,-1,1);
                                            echo "Проверка на PS $half_word Last:$last_letter_ps<BR>";
                                            if($last_letter_ps=="y")
                                            {
                                        ...
                                        {
                                            $last_letter2_ps=mb_substr($half_word,-1,2);
                                            echo "Проверка на PS $half_word Last:$last_letter2_ps<BR>";
                                            if($last_letter_ps=="ya")
                                            {
                                                echo "похоже на Пассив<BR>";
                                            }
                                        }
