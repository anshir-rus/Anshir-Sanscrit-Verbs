...
$command="VR-CaS-PrS-Pr";

$algo_db="algo_causative";
$comments_db="comments_causative";
$lico=3;
$chislo=1;
...
$refresh=$_REQUEST["refresh"];
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($res = mysqli_fetch_array($result)) {
            ...
            $one_line_array[$j][16]=$res['algo_causative'];
            $one_line_array[$j][17]=$res['comments_causative'];
           	$j++;
...
?>
<a href="/compare/compare_causative.php?refresh=1">Обновить данные</a>
<?
