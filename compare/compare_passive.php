...
$refresh=$_REQUEST["refresh"];
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($res = mysqli_fetch_array($result)) {
            ...
            $one_line_array[$j][16]=$res['algo_passive'];
            $one_line_array[$j][17]=$res['comments_passive'];
           	$j++;
...
?>
<a href="/compare/compare_passive.php?refresh=1">Обновить данные</a>
<?
...
$algo_db="algo_passive";
$comments_db="comments_passive";
$lico=3;
$chislo=1;
