...
for($i=0;$i<count($mool_array);$i++)
{
    ...
    echo "<tr $class>";
    echo "<td><a href='generator2.php?verbs=".$verb_id."' class='link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover'>".$mool_array[$i]."</a></td>
