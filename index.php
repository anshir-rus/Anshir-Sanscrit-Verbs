...
*/
 ...
 require_once "db.php";
    ...
    if (mysqli_num_rows($result) > 0) {
		...
		$answer.="<tr><td><a href='/generator.php?verbs=$id'>".$res['name']. "$omonim_text $adhoc_text</a></td><td>".$res['ryad']. "</td><td>".$res['whitney']. "</td><td>".$res['setnost']. "</td><td>".$res['type']. "</td><td>".$res['pada']. "</td><td>".$res['prs']. "</td><td>".$res['aos']. "</td><td>".$res['translate']. " ".$res['comments']. "</td></tr>";
      }
...
<body class="d-flex flex-column min-vh-100">
    ...
    Тестовая версия! Возможны опечатки, влияющие на конечный результат. <a class="link-danger  link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href='compare.php'>Сравнение с таблицей В.А.Кочергиной</a>
    </div>
